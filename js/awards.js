...
L.custom =
{
    ...
    baseSourceURL: "ec-mapeditor-data-",
    countriesMapping:[
    ...
    createSidebar:function(){
      ...
      for (var i = 0; i < categories.length; i++) {
        ...
        if (!this.categoryLayers[categories[i].name]) {
          this.categoryLayers[categories[i].name] = L.wt.markers("type":"FeatureCollection","features":[]
    ...
    addCategoryMarkersFromJson: function(json, country_code){
      ...
      for (var i = 0; i < categories.length; i++) {
        ...
        for (var j = 0; j < countryDataFeatures.length; j++) {
          console.log(countryDataFeatures[j].properties.category);
          if (countryDataFeatures[j].properties.category  && countryDataFeatures[j].properties.category.toLowerCase() == categories[i].name.toLowerCase()) {
        ...
        var options = {
          ...
          // Black blue (default) green orange pink red turquoise yellow.
                color:"" + categories[i].color,
                onEachFeature: function(feature,layer){
